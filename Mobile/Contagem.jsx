...
export default function Login() {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={{ fontSize: 35, start: -80, marginBottom: 100 , backgroundColor: '#e5937c', borderRadius:50 }}> Professor </Text>
    ...
    <ScrollView style= {styles.View}> 
        ...
        >
          <Text style={{ fontStyle: 'italic', fontWeight: '900', color: '#ffff' }}> Enviar</Text>
        </TouchableOpacity>
