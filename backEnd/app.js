...
app.listen(porta, () => {
    ...
    console.log(`http://10.188.10.109:${porta}/`)
    console.log(`http://10.188.10.109:${porta}/nome/nomes`)
    console.log(`http://10.188.10.109:${porta}/turma/turmas`)
    console.log(`http://10.188.10.109:${porta}/login`)
    console.log(`http://10.188.10.109:${porta}/contagem`)
})
